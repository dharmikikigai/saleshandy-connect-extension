...
const Login = () => (
  <>
    ...
    >
      <Card className="border-0 shadow-sm" style={{ borderRadius: '7px' }}>
        <Card.Body className="px-2 pb-2">
          <Card className="border-0 p-2" style={{ borderRadius: '7px' }}>
            ...
            >
              Your best lead finder tool is just a click away. From revealing
              contact info to adding them to sequence along with lot more
              features.
            </p>
            ...
            <Button
              ...
              onClick={() => {
                window.location.href =
                  'https://pyxis.lifeisgoodforlearner.com/login';
              }}
            >
              Log in
            </Button>
