    ...
    <>
      <div style={{ height: '345px' }}>
        ...
        <div style={{ marginTop: '5%' }}>
          <div style={{ position: 'absolute', left: '20px', top: '54px' }}>
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <div
            style={{ position: 'absolute', left: '165px', top: '54px' }}
          ...
          >
            ...
            {refreshTooltip && (
              <div
                style={{
                  position: 'absolute',
                  top: '22px', // adjust this based on your layout
                  left: '50%',
        ...
        />
        {/* Saleshandy Platform */}
        <div style={{ position: 'absolute', top: '110px', left: '1px' }}>
          <div
            style={{
              fontWeight: '500',
              fontSize: '12px',
          ...
          <div style={{ width: '300px', height: '16px' }}>
            {/* First SVG */}
            <div style={{ position: 'absolute', left: '14px', top: '25px' }}>
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
          ...
          <div style={{ width: '300px', height: '16px' }}>
            {/* First SVG */}
            <div style={{ position: 'absolute', left: '14px', top: '50px' }}>
              <svg
                width="17"
                height="17"
                viewBox="0 0 17 17"
            ...
            <div
              onClick={() => handleClick('https://my.saleshandy.com/prospects')}
          ...
          <div style={{ width: '300px', height: '16px' }}>
            ...
            {/* Sequence link svg */}
            <div
              onClick={() => handleClick('https://my.saleshandy.com/sequence')}
              style={{ position: 'absolute', top: '75px', left: '300px' }}
            >
              <svg
                width="17"
                height="17"
        ...
        <div style={{ marginTop: '2%' }}>
          ...
          <div
            ...
            style={{ position: 'absolute', top: '228px', left: '153px' }}
          >
            <svg
              width="15"
              height="15"
            ...
            {emailInsightTooltip && (
              ...
              >
                If turned on it tracks opens, clicks for emails sent from, Gmail
          ...
          <div
            ...
            style={{ position: 'absolute', top: '228px', right: '15px' }}
          ...
          <div style={{ width: '300px', height: '16px', marginTop: '1px' }}>
            <div
              style={{ position: 'absolute', right: '278px', marginTop: '7px' }}
            >
              <svg
                width="68"
                height="68"
