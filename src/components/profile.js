  ...
  <>
    ...
    <div style={{ marginTop: '13%' }}>
      ...
      <div className="p-4 text-center">
        ...
        <p style={{ fontSize: '12px', lineHeight: '3px', color: '#6B7280' }}>
    ...
    {/* Divider */}
    <div
      style={{ marginTop: '5%', border: '1.2px solid #F3F4F6', width: '300px' }}
    />
    {/* Saleshandy Platform */}
    <div style={{ marginTop: '2%' }}>
      ...
      <div style={{ width: '300px', height: '16px', marginTop: '13px' }}>
        ...
        <div style={{ position: 'absolute', top: '408px', right: '20px' }}>
          <svg
            width="17"
            height="17"
            viewBox="0 0 17 17"
      ...
      <div style={{ width: '300px', height: '16px', marginTop: '14px' }}>
        ...
        <div style={{ position: 'absolute', top: '438px', right: '20px' }}>
          <svg
            width="17"
            height="17"
            viewBox="0 0 17 17"
      ...
      <div style={{ width: '300px', height: '16px', marginTop: '15px' }}>
        ...
        <div style={{ position: 'absolute', top: '468px', right: '20px' }}>
          <svg
            width="17"
            height="17"
            viewBox="0 0 17 17"
    ...
    <div style={{ marginTop: '2%' }}>
      ...
      <div style={{ width: '300px', height: '16px', marginTop: '13px' }}>
        <div style={{ position: 'absolute', right: '278px', marginTop: '2px' }}>
          <svg
            width="68"
            height="68"
            viewBox="0 0 68 68"
